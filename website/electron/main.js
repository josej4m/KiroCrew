...
app.whenReady().then(async () => {
  ...
  // renderer sends the resolved mode ("dark" | "light") after any theme
  // change. Reuses updateWindowsTitleBarOverlay (also driven by syncNativeTheme
  // on load/focus) so every window converges on the same transparent,
  // zoom-aware overlay instead of two handlers racing with different colors.
